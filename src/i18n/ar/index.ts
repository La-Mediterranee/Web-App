...
const t = {
	...
	'customer': {
		...
		'login-form': {
			...
			'form-login-text':
				'.إذا كان لديك حساب ، فقم بتسجيل الدخول باستخدام عنوان بريدك الإلكتروني',
		},
		'signup-form': {
			'login': 'تسجيل الدخول',
	...
	'error': {
		...
		'page-lost-description':
			'الصفحة التي تبحث عنها غير متوفرة. حاول البحث مرة أخرى أو استخدم زر العودة للخلف أدناه.',
	},
	'products': {
		'text': 'منتجات',
		'details': 'تفاصيل',
	...
	'admin': {
		...
		'meta-data': {
			...
			'footer-left-raw-content':
				'<p>نحن نحب صياغة البرامج وحل مشاكل العالم الحقيقي مع الثنائيات. نحن ملتزمون للغاية بأهدافنا. نحن نستثمر مواردنا لإنشاء برامج وتطبيقات سهلة الاستخدام على مستوى عالمي للأعمال التجارية مع أرفع مستوى ، على أعلى مستوى من الخبرة التقنية.</p>',
