...
<script context="module" lang="ts">
	...
	import type { CartItem, MenuItem, Product, Topping, ToppingOption } from 'types/product';
...
<script lang="ts">
	...
	const action = `/products${category != null ? '/' + category : ''}/${name}`;
	...
	function openPopUp(e: Event) {
		...
		const selectedToppings: ToppingOption[] = [];
