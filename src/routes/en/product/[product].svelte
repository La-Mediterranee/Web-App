<script context="module" lang="ts">
	import type { LoadInput, LoadOutput, Page } from '@sveltejs/kit';
	...
	export async function load({ page, fetch }: ProductLoadInput): Promise<LoadOutput> {
		try {
			const url = `/product/${page.params.product}.json`;
