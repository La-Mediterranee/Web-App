...
export function isMouseMoveEvent(e: MouseEvent | TouchEvent): e is MouseEvent {
...
export interface CarouselProps {
	...
	children: any;
	customLeftArrow?: HTMLElement | null;
	customRightArrow?: HTMLElement | null;
	customDot?: HTMLElement | null;
	customButtonGroup?: HTMLElement | null;
	infinite?: boolean;
...
export default class Slider extends SvelteComponentTyped<CarouselProps> {
	...
	setClones: (slidesToShow: number, itemWidth?: number, forResizing?: boolean) => void; // reset carousel in infinite mode.
